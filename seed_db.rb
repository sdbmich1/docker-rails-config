...
library2.save
library2.addresses.create(street: '125 14th Street', city: 'Oakland', state: 'CA', zip: '94612')
...
library3.save
library3.addresses.create(street: '2090 Kittredge Street', city: 'Berkeley', state: 'CA', zip: '94704')
